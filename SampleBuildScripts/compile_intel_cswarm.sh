...
### Load the modules
module purge 
module load opt_local/1.0 mvapich2/2.2-intel-16.0-mlx 
module load ttl
#module load pmtl/4.0
#module load boost/1.63-mvapich2-2.2-gcc-6.2.0-mlx 
...
setenv confg_file_name SampleBuildScripts/config.site_intel_cswarm   #Give the name of the config.site file
