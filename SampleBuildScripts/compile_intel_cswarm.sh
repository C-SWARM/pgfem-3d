...
### Load the modules
module purge 
module load opt_local/1.0 ttl mvapich2/2.2-intel-16.0-mlx
module load gcc/6.2.0                # need ??? 
...
setenv path_to_hypre /afs/crc.nd.edu/group/cswarm/hypre/2.4.0b/intel/16.0/mvapich2/2.2 
setenv path_to_suitesparse /afs/crc.nd.edu/group/cswarm/SuiteSparse/src/SuiteSparse-2.1.1 
...
setenv path_to_pgfem3d_build /afs/crc.nd.edu/group/cswarm/pgfem_3d/build_pgfem3d_mvapich2-2.2-intel-16.0-mlx
...
git pull
make clean
make CC=mpicxx CXXFLAGS="-Wall -std=c++14 -fpermissive -Ofast -g"
echo "++++++++++++ Finished Compiling GCM +++++++++++"


### This takes to pgfem3d directory and pull its latest version 
cd $path_to_pgfem3d
git pull
