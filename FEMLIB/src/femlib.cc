...
void TEMP_VARIABLES::set_variable_size(int nne_t, int nne)
{
...
long FEMLIB::determine_integration_type(int e_type, int i_order)
{
  switch(i_order)
  {
    case 0:
...
void FEMLIB::initialization(int e_type, int i_order, int nne)
{
  int nsd = 3;
  long nint;
...
/// \return void
void FEMLIB::initialization(int e, 
                            const ELEMENT *elem, 
                            const NODE *node, 
                            int i_order, 
                            int is_total,
...
void FEMLIB::elem_shape_function(long ip, 
                                 int nne, 
                                 double *N)
{
...
void FEMLIB::update_shape_tensor(void)
{  
...
void FEMLIB::update_deformation_gradient(const int ndofn, double *u, double *F)
{
  double **F_mat;  
  F_mat = aloc2(3,3);                 
...
double FEMLIB::elem_volume(void)
{  
  double Volume;
