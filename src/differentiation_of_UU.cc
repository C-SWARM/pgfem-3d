    ...
    const PGFem3D_opt *opts)
{
  ...
  double Ts,POM,dGdt,N5,H_n,N4; /*H,N1,N2;*/

  // @todo N3 was reported as used-without-initialization in this function along
  //       some paths. It looks like some older code _did_ initialize it but was
  //       commented out. I added this constructor to make sure it's initialized
  //       along all paths. @cp should review this change. LD
  double N3{};
