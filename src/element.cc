...
*/
{
  ...
  pom = (ELEMENT*) PGFEM_calloc (ne, sizeof(ELEMENT));
...
//      }
    ...
    case 4: /* tets */
    case 10:
      pom[ii].bnd_type = PGFEM_calloc(4,sizeof(int));
      pom[ii].bnd_id = PGFEM_calloc(4,sizeof(int));
      break;
    case 8:
      pom[ii].bnd_type = PGFEM_calloc(6,sizeof(int));
      pom[ii].bnd_id = PGFEM_calloc(6,sizeof(int));
      break;
    default:
    ...
    case MINI_3F:
      pom[ii].n_bub_dofs = 3;
      pom[ii].n_bub = 1;
      pom[ii].bub_dofs = (double*) PGFEM_calloc (pom[ii].n_bub
						 *pom[ii].n_bub_dofs,
						 sizeof(double));

      pom[ii].d_bub_dofs = (double*) PGFEM_calloc (pom[ii].n_bub
						   *pom[ii].n_bub_dofs,
						   sizeof(double));
      break;

    default:
      pom[ii].bub_dofs = (double*) PGFEM_calloc (1,sizeof(double));
      pom[ii].d_bub_dofs = (double*) PGFEM_calloc (1,sizeof(double));
      break;
    }
    ...
    /* if (gem == 1) {
       ...
       pom[ii].gx1 = (double*) PGFEM_calloc (2,sizeof(double));
       pom[ii].gx2 = (double*) PGFEM_calloc (2,sizeof(double));
       pom[ii].gx3 = (double*) PGFEM_calloc (2,sizeof(double));
       } */
  }/* for each element */
