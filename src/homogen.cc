...
*/
{
  ...
  pom = PGFEM_calloc (TFA, i);

  for (ii=0;ii<i;ii++){
    pom[ii].Am = PGFEM_calloc (double, 36);
    pom[ii].A2 = PGFEM_calloc (double, 36);

    pom[ii].Dmm = PGFEM_calloc (double, 36);
    pom[ii].Dmd = PGFEM_calloc (double, 36);
    pom[ii].Dmb = PGFEM_calloc (double, 36);
    pom[ii].Dbm = PGFEM_calloc (double, 36);
    pom[ii].Dbb = PGFEM_calloc (double, 36);
    pom[ii].Dbd = PGFEM_calloc (double, 36);
    pom[ii].Ddm = PGFEM_calloc (double, 36);
    pom[ii].Ddd = PGFEM_calloc (double, 36);
    pom[ii].Ddb = PGFEM_calloc (double, 36);
  }
  if (pom == NULL){
