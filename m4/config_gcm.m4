...
AC_DEFUN([CONFIG_GCM], [
 ...
 LIBGCM_CPPFLAGS="-I$with_cnstvm/utils/include -I$with_cnstvm/material/include -I$with_cnstvm/elasticity/include -I$with_cnstvm/crystal_plasticity/include -I$with_cnstvm/data_structure/include"
